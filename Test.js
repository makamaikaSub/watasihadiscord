if (message.content.startsWith(prefix)) {
    ...
    function play(connection, message) {
      ...
      server.dispatcher = connection.playStream(ytdl(unplay_queue.url));
